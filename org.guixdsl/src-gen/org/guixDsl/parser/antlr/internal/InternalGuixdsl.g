...
entryRuleDslAbstractGuiElement returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDslAbstractGuiElementRule()); }
	 iv_ruleDslAbstractGuiElement=ruleDslAbstractGuiElement 
	 { $current=$iv_ruleDslAbstractGuiElement.current; } 
	 EOF 
;

// Rule DslAbstractGuiElement
ruleDslAbstractGuiElement returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    { 
        $current = $this_DslGuiModule_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_DslView_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleDslGuiModule returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDslGuiModuleRule()); }
	 iv_ruleDslGuiModule=ruleDslGuiModule 
	 { $current=$iv_ruleDslGuiModule.current; } 
	 EOF 
;

// Rule DslGuiModule
ruleDslGuiModule returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
(
		lv_documentation_0_0=RULE_STRING
		{
...
entryRuleDslView returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDslViewRule()); }
	 iv_ruleDslView=ruleDslView 
	 { $current=$iv_ruleDslView.current; } 
	 EOF 
;

// Rule DslView
ruleDslView returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
