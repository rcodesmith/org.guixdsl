...
public class GuixdslSyntacticSequencer extends AbstractSyntacticSequencer {

	protected GuixdslGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (GuixdslGrammarAccess) access;
