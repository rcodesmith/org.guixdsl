...
* generated by Xtext
*/
package org.guixdsl.ui.contentassist.antlr;
...
public class GuixdslParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.guixdsl.ui.contentassist.antlr.internal.InternalGuixdslParser createParser() {
		org.guixdsl.ui.contentassist.antlr.internal.InternalGuixdslParser result = new org.guixdsl.ui.contentassist.antlr.internal.InternalGuixdslParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getDslAbstractGuiElementAccess().getAlternatives(), "rule__DslAbstractGuiElement__Alternatives");
					...
					put(grammarAccess.getDslGuiModuleAccess().getGroup(), "rule__DslGuiModule__Group__0");
					put(grammarAccess.getDslGuiModuleAccess().getGroup_4(), "rule__DslGuiModule__Group_4__0");
					put(grammarAccess.getDslViewAccess().getGroup(), "rule__DslView__Group__0");
					...
					put(grammarAccess.getDslModelAccess().getElementsAssignment(), "rule__DslModel__ElementsAssignment");
					put(grammarAccess.getDslGuiModuleAccess().getDocumentationAssignment_0(), "rule__DslGuiModule__DocumentationAssignment_0");
					put(grammarAccess.getDslGuiModuleAccess().getNameAssignment_2(), "rule__DslGuiModule__NameAssignment_2");
					put(grammarAccess.getDslGuiModuleAccess().getHintAssignment_4_2(), "rule__DslGuiModule__HintAssignment_4_2");
					put(grammarAccess.getDslViewAccess().getDocumentationAssignment_0(), "rule__DslView__DocumentationAssignment_0");
					put(grammarAccess.getDslViewAccess().getNameAssignment_2(), "rule__DslView__NameAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.guixdsl.ui.contentassist.antlr.internal.InternalGuixdslParser typedParser = (org.guixdsl.ui.contentassist.antlr.internal.InternalGuixdslParser) parser;
			typedParser.entryRuleDslModel();
